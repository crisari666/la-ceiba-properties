          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li className="flex items-start gap-2.5">
                ...
                <span>Calle 75 #15-40, Oficina 301, Ibagué, Tolima, Colombia</span>
              </li>
              <li>
              ...
              <li>
                <a href="mailto:info@laceiba.group" className="flex items-center gap-2.5 hover:text-white transition-colors">
          ...
          <div>
            ...
            <div className="flex gap-3">
              {[
                ...
                { href: "https://www.tiktok.com/", label: "TikTok", icon: (
